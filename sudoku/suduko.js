        ...
        for(i=0;i<9;i++){
            ...
            for(j=0;j<9;j++){
                ...
                if( numbersToShow > 0 && rnd % 2 == 0){
                    document.getElementById("td" +i+j).innerHTML = '<input type="text" id="txt' + i + j + '" value="' + selectedBoard[i][j] + '"' + ' disabled  size="3">';
                    numbersToShow--;
                }else{
                    document.getElementById("td" +i+j).innerHTML = '<input type="text" id="' + "txt" +i+j +  '" size="3">';
                }
